...
set_property PACKAGE_PIN AM17 [get_ports {sondos_io\\.pcie_rst_n}]
#
#############################################################################################################
#
set_property PACKAGE_PIN AL9 [get_ports {sondos_io\\.pcie_clk_p}]
set_property PACKAGE_PIN AL8 [get_ports {sondos_io\\.pcie_clk_n}]

#set_property PACKAGE_PIN R9 [get_ports {sondos_io\\.qsfp0_refclk_p}]
#set_property PACKAGE_PIN R8 [get_ports {sondos_io\\.qsfp0_refclk_n}]
