...
if {[file exists $PROJECT_DIR/sondos_shell.gen/sondos_axi_crossbar/sondos_axi_crossbar_s4.xci]} {
  read_ip $PROJECT_DIR/sondos_shell.gen/sondos_axi_crossbar/sondos_axi_crossbar_s4.xci
  puts "found sondos_axi_crossbar_s4.xci"
} else {
  puts "did not find sondos_axi_crossbar_s4.xci, creating the ip ..."
  set argv [list $PROJECT_DIR/sondos_shell.gen]
  source $SHELL_PATH/common/modules/sondos_axi_crossbar_s4_xci.tcl
}
...
if {[file exists $PROJECT_DIR/sondos_shell.gen/aurora_firefly_0/aurora_firefly_0.xci]} {
  ...
  set argv [list $PROJECT_DIR/sondos_shell.gen]
  source $SHELL_PATH/common/phy/htg930_phy/aurora_firefly_0_xci.tcl
}

if {[file exists $PROJECT_DIR/sondos_shell.gen/aurora_firefly_1/aurora_firefly_1.xci]} {
  read_ip $PROJECT_DIR/sondos_shell.gen/aurora_firefly_1/aurora_firefly_1.xci
  puts "found aurora_firefly_1.xci"
} else {
  puts "did not find aurora_firefly_1.xci, creating the ip ..."
  set argv [list $PROJECT_DIR/sondos_shell.gen]
  source $SHELL_PATH/common/phy/htg930_phy/aurora_firefly_1_xci.tcl
}
...
if {[file exists $PROJECT_DIR/sondos_shell.gen/qdma_0/qdma_0.xci]} {
  ...
  set argv [list $PROJECT_DIR/sondos_shell.gen]
  source $SHELL_PATH/common/phy/htg930_phy/qdma_0_xci.tcl
}
...
add_files -norecurse $SHELL_PATH/common/modules/htg930_si5341_init_pkg.sv
add_files -norecurse $SHELL_PATH/common/modules/htg930_firefly_init_pkg.sv
add_files -norecurse $SHELL_PATH/common/modules/aurora_firefly_0_wrapper.sv
add_files -norecurse $SHELL_PATH/htg930_host/aurora_firefly_1_wrapper.sv
...
add_files -norecurse $SHELL_PATH/common/modules/sondos_axi_crossbar_s4_wrapper.sv
add_files -norecurse $SHELL_PATH/common/modules/htg930_si5341_init.sv
add_files -norecurse $SHELL_PATH/common/modules/htg930_firefly_init.sv
add_files -norecurse $SHELL_PATH/common/modules/sondos_i2c_master_core.sv
...
add_files -norecurse $SHELL_PATH/flash_programmers/htg930/sondos_shell_htg930_bpi_controller.sv
add_files -norecurse $SHELL_PATH/flash_programmers/htg930/sondos_shell_htg930_flash_top.sv

add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_host_if.sv
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_host_init.sv
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_host_csr.sv
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_host.sv

add_files -fileset constrs_1 -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_host.xdc
