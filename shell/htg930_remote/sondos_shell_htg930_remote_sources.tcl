...
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_remote_if.sv
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_remote_init.sv
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_remote_csr.sv
add_files -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_remote.sv

add_files -fileset constrs_1 -norecurse $SHELL_PATH/$BOARD_NAME/sondos_shell_htg930_remote.xdc
