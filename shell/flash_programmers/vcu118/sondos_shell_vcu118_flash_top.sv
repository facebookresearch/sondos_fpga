...
module sondos_shell_vcu118_flash_top(
    input clk,
    input reset,
    input done_beat,
...
sondos_shell_flash_csr #(.DEVICE_ID("VCU_118 ")) flash_csr_unit
(
   .clk,
   .reset,
...
sondos_shell_vcu118_qspi_controller sondos_vcu118_qspi_controller_unit(
   .clk,
   .reset(controller_reset),
   .done_beat,
