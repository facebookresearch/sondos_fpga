...
if {[file exists $PROJECT_DIR/sondos_shell.gen/qdma_0/qdma_0.xci]} {
  ...
  set argv [list $PROJECT_DIR/sondos_shell.gen]
  source $SHELL_PATH/common/phy/alveo_u250/qdma_0_xci.tcl
}
...
add_files -norecurse $SHELL_PATH/alveo_u250/sondos_shell_u250_host_if.sv
add_files -norecurse $SHELL_PATH/alveo_u250/sondos_shell_u250_host_csr.sv
add_files -norecurse $SHELL_PATH/alveo_u250/sondos_shell_u250_host.sv

add_files -fileset constrs_1 -norecurse $SHELL_PATH/alveo_u250/sondos_shell_u250_host.xdc
