...
set_property -dict [list CONFIG.pcie_blk_locn {X0Y1} CONFIG.csr_axilite_slave {true} CONFIG.testname {mm} CONFIG.pf0_bar2_scale_qdma {Megabytes} CONFIG.pf0_bar2_size_qdma {16} \
