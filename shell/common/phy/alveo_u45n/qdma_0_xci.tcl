...
set_property -dict [list CONFIG.pcie_blk_locn {PCIE4C_X0Y0} CONFIG.csr_axilite_slave {true} CONFIG.testname {mm} CONFIG.pf0_bar2_scale_qdma {Megabytes} CONFIG.pf0_bar2_size_qdma {32} \
                           CONFIG.pl_link_cap_max_link_width {X16} CONFIG.pl_link_cap_max_link_speed {8.0_GT/s} CONFIG.axi_data_width {512_bit} CONFIG.coreclk_freq {500} \
                           CONFIG.plltype {QPLL1} CONFIG.dma_intf_sel_qdma {AXI_MM} CONFIG.en_axi_st_qdma {false} \
