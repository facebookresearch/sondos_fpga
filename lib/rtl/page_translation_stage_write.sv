...
module page_translation_stage_write
...
logic [31:0] empty_credit_counter;
logic reached_negative_credit;
logic reached_negative_credit_d1;
...
assign axi_full_from_app.awready = axi_full_to_host.awready & allow_axif_write_req;
assign axi_full_to_host.awid    = axi_full_from_app.awid;
assign axi_full_to_host.awaddr  = {translated_axif_page_waddress,axi_full_from_app.awaddr[11:0]};
assign axi_full_to_host.awregion= axi_full_from_app.awregion;
assign axi_full_to_host.awlen   = axi_full_from_app.awlen;
assign axi_full_to_host.awsize  = axi_full_from_app.awsize;
assign axi_full_to_host.awburst = axi_full_from_app.awburst;
assign axi_full_to_host.awvalid = axi_full_from_app.awvalid & allow_axif_write_req;
assign axi_full_to_host.awuser  = axi_full_from_app.awuser;

assign axi_full_from_app.wready = axi_full_to_host.wready;
assign axi_full_to_host.wdata   = axi_full_from_app.wdata;
assign axi_full_to_host.wstrb   = axi_full_from_app.wstrb;
assign axi_full_to_host.wlast   = axi_full_from_app.wlast;
assign axi_full_to_host.wvalid  = axi_full_from_app.wvalid;
assign axi_full_to_host.wuser   = axi_full_from_app.wuser;

assign axi_full_to_host.bready  = axi_full_from_app.bready;
assign axi_full_from_app.bid    = axi_full_to_host.bid;
assign axi_full_from_app.bresp  = axi_full_to_host.bresp;
assign axi_full_from_app.buser  = axi_full_to_host.buser;
assign axi_full_from_app.bvalid = axi_full_to_host.bvalid;
...
sync_sdp_sram #(
 ...
 always_ff @(posedge clk) begin
    ...
    reached_negative_credit <= reset_interface_r | remaining_hw_credit[31];
    reached_negative_credit_d1 <= reset_interface_r | reached_negative_credit;
    empty_credit_counter <= (reset_interface_r)? '0:
                            (reached_negative_credit & ~reached_negative_credit_d1)? empty_credit_counter + 1'b1 : empty_credit_counter;
...
always_comb begin
    case(read_address[3:0])
        ...
        'd9 : selected_read_c = empty_credit_counter;
        'd10 : selected_read_c = timestamp;
